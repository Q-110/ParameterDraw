import type { DerivedSectionDefinition, FieldDefinition } from '../../../types'

export const sluiceBasicFields: FieldDefinition[] = [
...
export const sluiceDerivedSections: DerivedSectionDefinition[] = [
  {
    id: 'elevation',
    fields: [
